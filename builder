...
# Build box86
cd $dir/box86
mkdir build; cd build; cmake .. -DARM64=1 -DARM_DYNAREC=1 -DCMAKE_C_COMPILER=clang -DCMAKE_BUILD_TYPE=RelWithDebInfo -DBAD_SIGNAL=ON -DSD888=ON; make -j8
#make install
# Build box64
cd $dir/box64
mkdir build; cd build; cmake .. -DARM_DYNAREC=1 -DCMAKE_C_COMPILER=clang -DCMAKE_BUILD_TYPE=RelWithDebInfo -DBAD_SIGNAL=ON -DSD888=ON; make -j8
#make install
